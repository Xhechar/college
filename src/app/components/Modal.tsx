        ...
        `}>
          <div className="pt-4">
            <div className="flex justify-center items-center">
              <h2 className="h2 text-center">Awesome, <span className="relative z-[1]">You're in!
                <Image src={MCircle} alt="circle" className={`
          ...
          <div className="pt-4">
            <p className="body0 text-center text-sub max-[400px]:text-[18px]">Shh. Here's the secret...</p>
          </div>
          <div className="pt-4">
            <h3 className={`
          ...
          <div className="">
            <p className="body0 text-center text-sub pt-[39px] max-[400px]:pt-[20px]">
              <span className="border-t-2 border-[#BEC5D0] pt-[25px] inline-block max-[400px]:text-[18px] max-[400px]:pt-[20px]">Good secrets don't stay hidden. Pass it on carefully</span>
            </p>
          </div>
